...
### [REST API docs site - in progress](https://redacted-rest-api-295119.gitlab.io/) 
...
- Interesting pages: 
    - [Release notes](https://support.strivr.com/docs/release_notes_portal.htm) - Release notes for the Strivr customer portal
...
<img align="center" alt="image of the homepage for Arena PLM's help site" title="link to the context-sensitive help site for Arena PLM" width="650px" src="https://gitlab.com/vickeryc/vickeryc/-/raw/main/images/arena-help-homepage-full.png">

- I designed, authored, and mantained this help system for Arena Solutions, a SaaS PLM (Product Lifecycle Management) company
- The site is authored in DITA XML, then exported to and generated from [Madcap Flare](https://www.madcapsoftware.com/products/flare/).
- To review it, ask Chris for access, then see https://gitlab.com/samples3752527/christopher-vickery-samples and [the accompanying readme](https://gitlab.com/samples3752527/christopher-vickery-samples/-/blob/main/README-BOMControl%20Help%202.md?ref_type=heads).
